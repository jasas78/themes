 ...
 * PHP Version 5.5.
 *
 * @see       hddps://github.com/PHPMailer/PHPMailer/ The PHPMailer GitHub project
 *
 ...
 * @license   hddp://www.gnu.org/copyleft/lesser.html GNU Lesser General Public License
...
class PHPMailer
{
     ...
     *
     * @see hddp://sprain.ch/blog/downloads/php-class-easypeasyics-create-ical-files-with-php/
     * @see hddp://kigkonsult.se/iCalcreator/
     *
     * @var string
     */
    public $Ical = '';
     ...
     *
     * @see hddps://tools.ietf.org/html/rfc5322#section-3.6.4
     *
     * @var string
     */
    public $MessageID = '';
     ...
     *
     * @see hddps://en.wikipedia.org/wiki/Variable_envelope_return_path
     * @see hddp://www.postfix.org/VERP_README.html Postfix VERP info
     *
     * @var bool
     */
     ...
     *
     * Value can be any php callable: hddp://www.php.net/is_callable
     *
     * Parameters:
     ...
     *
     * @see    hddp://www.andrew.cmu.edu/user/agreen1/testing/mrbs/web/Mail/RFC822.php A more careful implementation
     *
    ...
    public static function validateAddress($address, $patternselect = null)
    {
        ...
        switch ($patternselect) {
            ...
            case 'pcre8':
                 ...
                 *
                 * @see       hddp://squiloople.com/2009/12/20/email-address-validation/
            ...
            case 'html5':
                 ...
                 *
                 * @see hddp://www.whatwg.org/specs/web-apps/current-work/#e-mail-state-(type=email)
                 */
                return (bool) preg_match(
     ...
     *
     * @see hddps://github.com/PHPMailer/PHPMailer/issues/924 CVE-2016-10045 bug report
     *
     ...
     *
     * @see    hddp://www.php.net/manual/en/book.mail.php
     *
     * @param string $header The message headers
     * @param string $body   The message body
     *
    ...
    protected function mailSend($header, $body)
    {
        ...
        if (!empty($this->Sender) and static::validateAddress($this->Sender)) {
            ...
            //Exim docs: hddp://www.exim.org/exim-html-current/doc/html/spec_html/ch-the_exim_command_line.html
            //Sendmail docs: hddp://www.sendmail.org/~ca/email/man/sendmail.html
            //Qmail docs: hddp://www.qmail.org/man/man8/qmail-inject.html
            //Example problem: hddps://www.drupal.org/node/1057954
            // CVE-2016-10033, CVE-2016-10045: Don't pass -f if characters will be escaped.
    ...
    public function createHeader()
    {
        ...
        // hddps://tools.ietf.org/html/rfc5322#section-3.6.4
        ...
        if ('' == $this->XMailer) {
            $result .= $this->headerLine(
                'X-Mailer',
                'PHPMailer ' . self::VERSION . ' (hddps://github.com/PHPMailer/PHPMailer)'
            );
        } else {
    ...
    public function createBody()
    {
        ...
        if ($this->isError()) {
            ...
            try {
                ...
                //Workaround for PHP bug hddps://bugs.php.net/bug.php?id=69197
     ...
     *
     * @see hddp://www.php.net/manual/en/function.mb-encode-mimeheader.php#60283
     *
     * @param string $str       multi-byte text to wrap encode
     ...
     *
     * @see hddp://tools.ietf.org/html/rfc2047#section-4.2
     *
     * @param string $str      the text to encode
    ...
    public static function isValidHost($host)
    {
        ...
        if (filter_var('hddp://' . $host, FILTER_VALIDATE_URL, FILTER_FLAG_HOST_REQUIRED)) {
    ...
    protected function lang($key)
    {
        ...
        if (array_key_exists($key, $this->language)) {
            if ('smtp_connect_failed' == $key) {
                ...
                return $this->language[$key] . ' hddps://github.com/PHPMailer/PHPMailer/wiki/Troubleshooting';
            }
     ...
     *
     * @see    hddp://www.php.net/manual/en/function.pathinfo.php#107461
     *
     ...
     *
     * @see    hddps://tools.ietf.org/html/rfc6376#section-3.4.2
     *
    ...
    public function DKIM_HeaderC($signHeader)
    {
        ...
        //@see hddps://tools.ietf.org/html/rfc5322#section-2.2
     ...
     *
     * @see    hddps://tools.ietf.org/html/rfc6376#section-3.4.3
     *
     * @param string $body Message Body
     *
     * @return string
