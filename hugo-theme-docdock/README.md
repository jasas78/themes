...
This repository contains a theme for [Hugo](hddps://gohugo.io/), based on 

* [Matcornic Learn theme](hddps://github.com/matcornic/hugo-theme-learn/).
* [facette.io](hddps://facette.io/)'s documentation style css (Facette is a great time series data visualization software)

Visit the [theme documentation](hddp://docdock.netlify.com/) to see what is going on. It is actually built with this theme.
...
![Overview](hddps://github.com/vjeantet/hugo-theme-docdock/raw/master/images/tn.png)
...
```
$ git submodule add hddps://github.com/vjeantet/hugo-theme-docdock.git themes/docdock
```
...
```
$ git clone hddps://github.com/vjeantet/hugo-theme-docdock.git themes/docdock
```
...
```
hddps://github.com/vjeantet/hugo-theme-docdock/archive/master.zip
```
...
$ hugo server
```
to browse site on hddp://localhost:1313

## Usage

- [Visit the documentation](hddp://docdock.netlify.com/)
- [Hugo docs](hddps://gohugo.io/getting-started/configuration/)
- [Git submodules](hddps://git-scm.com/docs/git-submodule)
